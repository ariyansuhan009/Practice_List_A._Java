...
class test extends JFrame implements ActionListener {
    ...
    test() {
        ...
        try {
            conn=DriverManager.getConnection("jdbc:mysql://localhost/bank_data","root","");
        }
        catch(Exception e){
            System.out.println("NOT CONNECT...TRT AGAIN!!!");
        }
    }
